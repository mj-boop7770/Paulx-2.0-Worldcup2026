...
const traductions = {
    ...
    sw: { title: "WORLDCUP2026 · MUJOS OCTOPUS", sub: "AI FOOTBALL ORACLE · 48 NATIONS · LIVE SCORES", dates: "11 JUNI - 19 JULAI 2026", groups: "MAKUNDI", schedule: "RATIBA", predict: "UTABIRI", dossier: "FAILI", news: "HABARI", oracleBtn: "ORACLE - TABIRI MCHEZO", winA: "USHINDI A", draw: "SARE", winB: "USHINDI B", placeholder: "Ufaransa, Hispania, Ujerumani...", open: "FUNGUA", attack: "SHAMBULIO", defense: "ULINZI", form: "HALI", mental: "AKILI", coach: "KOCHA", keyplayer: "MCHEZAJI MUHIMU", stars: "NYOTA", history: "HISTORIA", all: "YOTE", grp: "KIKUNDI ", loadingMatch: "⏳ Inapakia...", noMatch: "Hakuna michezo", done: "✅ KAMATA", at: "saa", diffTeams: "Chagua timu mbili tofauti", notFound: "Timu haipatikani: ", loadingNews: "📰 Inapakia habari...", translating: "🌐 Inatafsiri...", noNews: "Hakuna habari", errorNews: "⚠️ Hitilafu habari" },
    ar: { title: "WORLDCUP2026 · MUJOS OCTOPUS", sub: "AI FOOTBALL ORACLE · 48 NATIONS · LIVE SCORES", dates: "11 يونيو - 19 يوليو 2026", groups: "المجموعات", schedule: "جدول المباريات", predict: "التنبؤات", dossier: "الملفات", news: "أخبار", oracleBtn: "الأوراكل - توقع المباراة", winA: "الفوز أ", draw: "تعادل", winB: "الفوز ب", placeholder: "فرنسا، إسبانيا، ألمانيا...", open: "افتح", attack: "الهجوم", defense: "الدفاع", form: "الشكل", mental: "عقلي", coach: "المدرب", keyplayer: "لاعب المفتاح", stars: "النجوم", history: "التاريخ", all: "الكل", grp: "المجموعة ", loadingMatch: "⏳ جاري التحميل...", noMatch: "لا توجد مباريات", done: "✅ تم", at: "في", diffTeams: "اختر فريقين مختلفين", notFound: "فريق غير موجود: ", loadingNews: "📰 جاري تحميل الأخبار...", translating: "🌐 جاري الترجمة...", noNews: "لا توجد أخبار", errorNews: "⚠️ خطأ الأخبار" },
    rw: { title: "WORLDCUP2026 · MUJOS OCTOPUS", sub: "AI FOOTBALL ORACLE · 48 NATIONS · LIVE SCORES", dates: "11 Kamena - 19 Nyakanga 2026", groups: "AMATSINDA", schedule: "GAHUNDA", predict: "IGENAMIGABIRO", dossier: "AMADOSIYE", news: "AMAKURU", oracleBtn: "ORACLE - KARABIGABIRO UMUSANZU", winA: "INZIRA A", draw: "BUNGUNGUKE", winB: "INZIRA B", placeholder: "Ubufaransa, Espanye, Ubudage...", open: "FUNGURA", attack: "IBITERO", defense: "KURINDA", form: "IMITERERE", mental: "IRITONDA", coach: "UMUGEZI", keyplayer: "UMUKINNYI INZIRA", stars: "INYOTA", history: "AMATEKA", all: "BYOSE", grp: "ITANDUKANIRO ", loadingMatch: "⏳ Iratara...", noMatch: "Nta musanzu", done: "✅ CURUZA", at: "kuri", diffTeams: "Hitamo umusanzu ibiri bitandukanye", notFound: "Umusanzu ntabwo waboneka: ", loadingNews: "📰 Iratara amakuru...", translating: "🌐 Iravuguruza...", noNews: "Nta makuru", errorNews: "⚠️ Ikosa ry'amakuru" }
};
